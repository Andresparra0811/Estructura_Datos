...
public class Utils {
     ...
     * @param deptos el objeto país donde guardaremos los diversos deptos
     * @return el número de datos obtenidos
     */
    public static int obtenerDepartamentos(IList<Departamento> deptos) {
        int n = 0;
        ...
        try {
            ...
            while ((linea = reader.readNext()) != null) {
                if (n > 0) {
                    ...
                    Departamento d = new Departamento(nom, pobl, sup, idh, añoc);
                    deptos.add(d);
                }
     ...
     * @param municipios el objeto donde almacenaremos los datos de los municipios
     * @return el número de municipios obtenidos
     */
    public static int obtenerMunicipios(IList<Municipio> municipios) {
        int n = 0;
        try {
            ...
            while ((linea = reader.readNext()) != null) {
                if (n > 0) {
                    ...
                    Municipio m = new Municipio(cod, nom, dep, pobUrb, pobRur, cap);
                    municipios.add(m);
                }
                n++;
            }
