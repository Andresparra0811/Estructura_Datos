...
public class PanelLista extends JPanel implements ListSelectionListener {
     ...
     */
    public void actualizarLista(IList<Aspirante> listaActualizada) {
        Aspirante[] aspirantes = new Aspirante[listaActualizada.getSize()];
        int i = 0;
        for (Aspirante a : listaActualizada) {
            aspirantes[i++] = a;
        }
        listaAspirantes.setListData(aspirantes);
