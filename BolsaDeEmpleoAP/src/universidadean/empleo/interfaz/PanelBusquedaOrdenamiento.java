...
public class PanelBusquedaOrdenamiento extends JPanel implements ActionListener {
    ...
    private static final String BUSCAR_NOMBRE = "BuscarNombre";
    ...
    /**
     * Este es el botón para realizar una búsqueda por nombre (binaria)
     */
    private JButton botonBuscarBinaria;

    /**
     * Este es el botón de ordenar por nombres
     */
    private JButton botonOrdenarPorNombre;
    ...
    public PanelBusquedaOrdenamiento(InterfazBolsaDeEmpleo interfaz) {
        ...
        botonOrdenarPorNombre.setActionCommand(ORDENAR_NOMBRE);
        botonOrdenarPorNombre.addActionListener(this);
        gbc.gridy = 1;
        add(botonOrdenarPorNombre, gbc);
        ...
        botonBuscarBinaria = new JButton("Busqueda Binaria");
        botonBuscarBinaria.setActionCommand(BUSCAR_NOMBRE);
        botonBuscarBinaria.addActionListener(this);
        gbc.gridy = 5;
        add(botonBuscarBinaria, gbc);
    ...
    public void actionPerformed(ActionEvent evento) {
        ...
        else if (BUSCAR_NOMBRE.equals(comando)) {
