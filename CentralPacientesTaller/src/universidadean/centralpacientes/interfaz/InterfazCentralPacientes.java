...
import universidadean.centralpacientes.mundo.CentralPacientes;
import universidadean.centralpacientes.mundo.NoExisteException;
import universidadean.centralpacientes.mundo.Paciente;
import universidadean.centralpacientes.mundo.YaExisteException;
...
public class InterfazCentralPacientes extends JFrame {
     ...
     */
    public IList<String> darClinicasCentral() {
    ...
    public void reqFuncOpcion1() {
        ...
        JOptionPane.showMessageDialog(this, "El número de mujeres es " + resultado, "Respuesta", JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public void reqFuncOpcion2() {
        ...
        JOptionPane.showMessageDialog(this, "El número de hombres es " + resultado, "Respuesta", JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public void reqFuncOpcion3() {
        Paciente resultado = central.darPacienteMenorCodigo();
        if (resultado != null) {
            String resp = String.format("Paciente\nCodigo: %d\nNombre: %s\nClínica: %s\nSexo: %s",
                    resultado.darCodigo(), resultado.darNombre(), resultado.darClinica(), resultado.darSexo() == HOMBRE ? "Masculino" : "Femenino");
            JOptionPane.showMessageDialog(this, resp, "Menor codigo", JOptionPane.INFORMATION_MESSAGE);
        }
        else {
            JOptionPane.showMessageDialog(this, "La lista esta vacía", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    public void reqFuncOpcion4() {
        Paciente resultado = central.darPacienteMayorCodigo();
        if (resultado != null) {
            String resp = String.format("Paciente\nCodigo: %d\nNombre: %s\nClínica: %s\nSexo: %s",
                    resultado.darCodigo(), resultado.darNombre(), resultado.darClinica(), resultado.darSexo() == HOMBRE ? "Masculino" : "Femenino");
            JOptionPane.showMessageDialog(this, resp, "Mayor codigo", JOptionPane.INFORMATION_MESSAGE);
        }
        else {
            JOptionPane.showMessageDialog(this, "La lista esta vacía", "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public void reqFuncOpcion5() {
        double resultado = central.promedioCodigoMujeres();
        JOptionPane.showMessageDialog(this, String.format("El promedio del código de las mujeres es %.2f", resultado),
