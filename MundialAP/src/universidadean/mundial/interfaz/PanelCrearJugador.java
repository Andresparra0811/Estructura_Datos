...
public class PanelCrearJugador extends JPanel implements ActionListener {
    ...
    /**
     * El comando para guardar un jugador
     */
    private static final String GUARDAR_JUGADOR = "GuardarJugador";
     ...
     *
     * @param d Dialogo con el cual se crea un jugador
     * @param jugador el jugador que vamos a modificar
     */
    public PanelCrearJugador(DialogoCrearJugador d, Jugador jugador) {
        dialogo = d;
        ...
        txtPosicion = new JTextField(String.valueOf(jugador.getPosicion()));
        txtPosicion.setPreferredSize(new Dimension(80, 25));
        gbc.gridx = 1;
        add(txtPosicion, gbc);
        ...
        txtSalario = new JTextField(String.valueOf(jugador.getSalario()));
        txtSalario.setPreferredSize(new Dimension(80, 25));
        gbc.gridx = 1;
        add(txtSalario, gbc);
        ...
        JPanel panelImagen = new JPanel();
        panelImagen.setLayout(new GridLayout(1, 2, 3, 3));
        txtImagen = new JTextField(jugador.getImagen());
        panelImagen.add(txtImagen);
        ...
        botonAgregarJugador = new JButton("Guardar");
        botonAgregarJugador.setActionCommand(GUARDAR_JUGADOR);
        botonAgregarJugador.addActionListener(this);
        gbc.gridx = 0;
        gbc.gridy = 0;
        panelBotones.add(botonAgregarJugador, gbc);
    ...
    public void actionPerformed(ActionEvent evento) {
        ...
        else if (GUARDAR_JUGADOR.equals(comando)) {
            dialogo.guardarJugador();
        }
